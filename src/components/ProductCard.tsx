...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <motion.div 
      ...
      className="group relative bg-[#18181b] rounded-xl overflow-hidden border border-[rgba(255,255,255,0.1)] hover:shadow-2xl hover:shadow-[#D4AF37]/10 hover:border-[#D4AF37]/30 transition-all duration-300 flex flex-col"
    >
      <Link to={`/products/${product.id}`} className="block relative aspect-square overflow-hidden bg-[#27272a]">
        ...
        <button 
          ...
          className="absolute top-3 right-3 p-2 rounded-full bg-[#18181b]/80 backdrop-blur-sm hover:bg-[#18181b] text-[#a1a1aa] hover:text-[#D4AF37] transition-colors z-10"
        >
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-[rgba(255,255,255,0.1)]">
          ...
          {quantity > 0 ? (
            <div className="flex items-center gap-2">
              <div className="flex items-center border border-[#D4AF37] rounded">
                <button 
                  ...
                  className="px-2 py-1 text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#000000] transition-colors"
                >
                  -
                </button>
              ...
              <Link 
                to="/cart"
                className="flex items-center justify-center bg-[#D4AF37] text-[#000000] px-2 py-1.5 rounded text-xs font-semibold transition-colors hover:bg-[#c4a030]"
                title="Go to Cart"
              >
                Cart
              </Link>
            ...
            <button 
              ...
              className="flex items-center justify-center bg-transparent border border-[#D4AF37] text-[#D4AF37] px-3 py-1.5 rounded text-xs font-semibold transition-all duration-300 group-hover:bg-[#D4AF37] group-hover:text-[#000000]"
              title="Add to Cart"
            >
              + ADD
            </button>
