            ...
            <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full bg-[#000000] border border-[rgba(255,255,255,0.1)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-colors" placeholder="John" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#a1a1aa] mb-2">Last Name</label>
                  <input type="text" className="w-full bg-[#000000] border border-[rgba(255,255,255,0.1)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-colors" placeholder="Doe" />
                </div>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-[#a1a1aa] mb-2">Email Address</label>
                <input type="email" className="w-full bg-[#000000] border border-[rgba(255,255,255,0.1)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-colors" placeholder="john@example.com" />
              </div>
              
              <div>
                <label className="block text-sm font-medium text-[#a1a1aa] mb-2">Subject</label>
                <select className="w-full bg-[#000000] border border-[rgba(255,255,255,0.1)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-colors appearance-none">
              ...
              <div>
                ...
                <textarea rows={5} className="w-full bg-[#000000] border border-[rgba(255,255,255,0.1)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-colors resize-none" placeholder="How can we help you crush your goals?"></textarea>
              </div>
              
              <button type="submit" className="w-full bg-[#D4AF37] hover:bg-[#c4a030] text-[#000000] font-bold py-4 rounded-xl flex justify-center items-center gap-2 transition-transform transform active:scale-95 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <motion.div whileHover={{ y: -5 }} className="bg-[#18181b] p-6 rounded-2xl border border-[rgba(255,255,255,0.1)] flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-[#27272a] rounded-full flex items-center justify-center mb-4 text-[#D4AF37]">
            ...
            <div className="bg-[#D4AF37] p-8 rounded-2xl flex items-center justify-between shadow-[0_0_40px_rgba(212,175,55,0.15)] relative overflow-hidden group">
              ...
              <div className="flex gap-3 relative z-10">
                <a href="https://www.instagram.com/omfitness______?igsh=NmJmcmZscjI3OWZv" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#000000] rounded-full flex items-center justify-center text-[#D4AF37] hover:scale-110 transition-transform">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 bg-[#000000] rounded-full flex items-center justify-center text-[#D4AF37] hover:scale-110 transition-transform">
