    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#0a0a0a] px-4 relative">
        ...
        <div className="bg-[#1a1a1a] p-8 rounded-full shadow-none mb-6">
          <Heart className="h-16 w-16 text-[#a0a0a0]" />
        </div>
    ...
    <div className="bg-[#0a0a0a] min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map(product => (
            <div key={product.id} className="bg-[#1a1a1a] rounded-xl overflow-hidden border border-[#2a2a2a] shadow-none flex flex-col">
              <div className="relative aspect-square bg-[#252525]">
                ...
                <button 
                  ...
                  className="absolute top-3 right-3 p-2 rounded-full bg-[#1a1a1a]/80 backdrop-blur-sm hover:bg-[#1a1a1a] text-[#D4AF37] transition-colors z-10"
                >
