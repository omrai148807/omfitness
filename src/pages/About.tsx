      ...
      <section className="relative pt-32 pb-40 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          >
            ...
            <p className="text-xl text-[#a1a1aa] leading-relaxed mb-10 border-l-4 border-[#D4AF37] pl-6 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div 
                ...
                key={value.title}
                className="bg-[#18181b] p-8 rounded-2xl border border-[rgba(255,255,255,0.1)] group hover:border-[#D4AF37]/50 transition-colors"
              >
                <div className="w-14 h-14 bg-[#000000] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform group-hover:bg-[#D4AF37]/10">
